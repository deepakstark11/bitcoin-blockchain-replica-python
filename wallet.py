...
class Wallet:
    ...
    def sign_transanction(self, sender, recipient, amount):
    ...
    @staticmethod
    def verify_transanction(transaction):
        ...
        public_key = RSA.importKey(binascii.a2b_hex(transaction.sender))
        verifier = PKCS1_v1_5.new(public_key)
        h = SHA256.new((str(transaction.sender) + str(transaction.recipient) +
                        str(transaction.amount)).encode('utf8'))
        return verifier.verify(h, binascii.a2b_hex(transaction.signature))
